/*------------------------------------------------------------------------------------------------------------------
-- SOURCE FILE: recordgenerator.h - Voice Data Container for reading
--
-- PROGRAM:     commAudio
--
-- FUNCTIONS:
...
--
-- NOTES:
-- Handles all microphone input and stores them into a circular buffer when 40 000 bytes of data has been read
-- successfully.
----------------------------------------------------------------------------------------------------------------------*/
